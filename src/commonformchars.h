...
#ifndef COMMONDEFCHARS_H
#define COMMONDEFCHARS_H
#include <ncurses.h>
#define NEXT_CHAR KEY_RIGHT
#define PREV_CHAR KEY_LEFT
#define NEXT_FIELD (9) /* tab */
#define NEXT_FIELD2 KEY_NPAGE /* tab */
#define PREV_FIELD KEY_PPAGE
#define BELOW_FIELD KEY_DOWN
#define UPPER_FIELD KEY_UP
#define CLEAR_FORM (330) /* delete key ? */
#define SYSCOM_SAVEMSG_KEY (KEY_F(12))
